...
<div class="container justify-content-center" style="text-align: center;" align="center'">
    ...
    <form action="/jobs" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="dept" name="dept" value="{{ old('dept') }}" required
        ...
        <div class="row">
            <div class="col">
                ...
                <input type="date" class="form-control" id="dat" value="{{ old('dat') }}" name="dat" required>
            </div>
            <div class="col">
                <label for="expdat" class="form-label">Expiry Date</label>
                <input type="date" class="form-control" id="expdat" value="{{ old('expdat') }}" name="expdat">
            </div>
        </div>
        <br>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <input type="submit" class="form-control btn btn-primary" id="submit" name="submit" value="Post Ad">
            </div>
        </div>
    </form>
</div>
